...
if ( ! class_exists( 'Payzaty' ) ) :
	...
	final class Payzaty {
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, __( 'You are not allowed to clone this class.', 'payzaty' ), '1.6.0' );
		}
		...
		public function __wakeup() {
			_doing_it_wrong( __FUNCTION__, __( 'You are not allowed to unserialize this class.', 'payzaty' ), '1.6.0' );
		}
